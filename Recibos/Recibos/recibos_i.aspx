<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="recibos_i.aspx.cs" Inherits="Recibos.Recibos.recibos_i" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="table">
        <tr>
            <td>Proveedor:</td>
            <td>
                <asp:TextBox ID="txtProveedor" MaxLength="50" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvProveedor" runat="server" ControlToValidate="txtProveedor"
                    Display="Dynamic" ErrorMessage="El proveedor es requerido" ValidationGroup="vlg1"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>Monto:</td>
        ...
        <tr>
            <td>Comentario:</td>
            <td>
                <asp:TextBox ID="txtComentario" MaxLength="100" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFecha" AutoCompleteType="Disabled" runat="server"></asp:TextBox>
        ...
        <tr>
            <td>Codigo:</td>
            <td>
                <asp:TextBox ID="txtCodigo" MaxLength="50" runat="server"></asp:TextBox>
